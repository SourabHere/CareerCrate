...
})({"gp2uC":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "b6c21840eb417ecb";
"use strict";
...
},{}],"atOMt":[function(require,module,exports) {
var _jobSearch = require("./JobSearch");
const jobSearch = new (0, _jobSearch.JobSearch)("#search-form", ".result-container", ".loading-element", "#location", ".error-container");
...
class JobSearch {
    constructor(searchFormSelector, resultsContainerSelector, loadingElementSelector, citySelector, errorContainer){
    ...
    setCountryCode() {
        ...
        fetch(endpoint, {
            ...
            if (data && data.length > 0) this.countryCodes = data[0].iso2.toLowerCase();
        }).catch((error)=>{
            console.error(error);
        });
    }
    ...
    configureFormListener() {
        this.searchForm.addEventListener("submit", (e)=>{
            ...
            const { search , location: location1 , country  } = (0, _utils.extractFormData)(this.searchForm);
            let ccode = "";
            const endpoint = `https://api.api-ninjas.com/v1/country?name=${location1}`;
            const headers = {
                "X-Api-Key": "7UbqgI2qdeOQQB6stFq5bA==L7XPu56NDebo0R4u"
            };
            fetch(endpoint, {
                ...
                if (data && data.length > 0) {
                    ...
                    console.log(`The country code for ${location1} is ${this.countryCodes}.`);
                    ccode = data[0].iso2.toLowerCase();
                    if (arr.includes(ccode)) {
                        this.setCurrencyCode();
                        fetch(`https://average-jade-loincloth.cyclic.app/?search=${search}&location=${location1}&country=${ccode}`).then((response)=>response.json()).then(({ results  })=>{
...
parcelHelpers.export(exports, "extractFormData", ()=>extractFormData);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gp2uC","atOMt"], "atOMt", "parcelRequire10c2")

//# sourceMappingURL=index.eb417ecb.js.map
